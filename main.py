...
def main():
    ...
    # Program Arguments
    parser.add_argument("--mode", type=str, default="train", help="Mode to run the program in: "
                                                                  "train, eval")
    ...
    # Save Training arguments into file ================================================================================
    if args.mode != "eval":
    ...
    if args.mode == "train":
        train_model(args, model, criterion, vit_model, dataset, train_dataloader, optimizer, loss_log_path)
