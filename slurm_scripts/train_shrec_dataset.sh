...
#SBATCH --job-name=particle_1U6G_fbp_noise_0db     #Name of your job
...
#SBATCH --output=job_results/particle_1U6G_fbp_noise_0db.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/particle_1U6G_fbp_noise_0db.e%j    #Path and name to the file for the STDERR
