...
#SBATCH --job-name=slightly_smaller_z_depth_finetuned_vit_dropout_prob_0.2     #Name of your job
...
#SBATCH --output=job_results/slightly_smaller_z_depth_finetuned_vit_dropout_prob_0.2.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/slightly_smaller_z_depth_finetuned_vit_dropout_prob_0.2.e%j    #Path and name to the file for the STDERR
