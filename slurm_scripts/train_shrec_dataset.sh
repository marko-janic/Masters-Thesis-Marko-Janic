...
#SBATCH --job-name=ACTUAL_best_model_shrec_reconstruction_base_1_train    #Name of your job
...
#SBATCH --output=job_results/ACTUAL_best_model_shrec_reconstruction_base_1_train.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/ACTUAL_best_model_shrec_reconstruction_base_1_train.e%j    #Path and name to the file for the STDERR
