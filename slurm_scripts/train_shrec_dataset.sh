...
#SBATCH --job-name=shrec_dataset_moderate_noise_training     #Name of your job
...
#SBATCH --output=job_results/shrec_dataset_moderate_noise_training.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/shrec_dataset_moderate_noise_training.e%j    #Path and name to the file for the STDERR
