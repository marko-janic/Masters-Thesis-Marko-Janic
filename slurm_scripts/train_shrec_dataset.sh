...
#SBATCH --job-name=ACTUAL_best_model_shrec_reconstruction_base    #Name of your job
...
#SBATCH --output=job_results/ACTUAL_best_model_shrec_reconstruction_base.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/ACTUAL_best_model_shrec_reconstruction_base.e%j    #Path and name to the file for the STDERR
