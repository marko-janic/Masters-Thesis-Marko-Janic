...
#SBATCH --job-name=potential_best_model_fbp_0dB    #Name of your job
...
#SBATCH --output=job_results/potential_best_model_fbp_0dB.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/potential_best_model_fbp_0dB.e%j    #Path and name to the file for the STDERR
