...
#SBATCH --job-name=random_sub_micrographs     #Name of your job
...
#SBATCH --output=job_results/random_sub_micrographs.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/random_sub_micrographs.e%j    #Path and name to the file for the STDERR
