...
#SBATCH --job-name=shrecs_reconstruction_volume_attempt_4    #Name of your job
...
#SBATCH --output=job_results/shrecs_reconstruction_volume_attempt_4.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/shrecs_reconstruction_volume_attempt_4.e%j    #Path and name to the file for the STDERR
