...
#SBATCH --job-name=multiple_shrec_volumes_smaller_model_128_64_32     #Name of your job
...
#SBATCH --output=job_results/multiple_shrec_volumes_smaller_model_128_64_32.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/multiple_shrec_volumes_smaller_model_128_64_32.e%j    #Path and name to the file for the STDERR
