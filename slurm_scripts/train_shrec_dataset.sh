...
#SBATCH --job-name=finetune_4_vit_layers    #Name of your job
...
#SBATCH --output=job_results/finetune_4_vit_layers.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/finetune_4_vit_layers.e%j    #Path and name to the file for the STDERR
