...
#SBATCH --job-name=traing_vit_from_scratch_0dB    #Name of your job
...
#SBATCH --output=job_results/traing_vit_from_scratch_0dB.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/traing_vit_from_scratch_0dB.e%j    #Path and name to the file for the STDERR
