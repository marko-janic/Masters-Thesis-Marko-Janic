...
#SBATCH --job-name=potential_best_model    #Name of your job
...
#SBATCH --output=job_results/potential_best_model.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/potential_best_model.e%j    #Path and name to the file for the STDERR
