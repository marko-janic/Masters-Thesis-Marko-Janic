...
#SBATCH --job-name=traing_vit_from_scratch_10dB_COMPARISON_FINETUNE    #Name of your job
...
#SBATCH --output=job_results/traing_vit_from_scratch_10dB_COMPARISON_FINETUNE.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/traing_vit_from_scratch_10dB_COMPARISON_FINETUNE.e%j    #Path and name to the file for the STDERR
