...
#SBATCH --job-name=shrec_dataset_bigger_heatmaps_no_noise     #Name of your job
...
#SBATCH --output=job_results/shrec_dataset_bigger_heatmaps_no_noise.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/shrec_dataset_bigger_heatmaps_no_noise.e%j    #Path and name to the file for the STDERR
