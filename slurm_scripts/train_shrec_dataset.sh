...
#SBATCH --job-name=testing_different_particle_sizes_and_random_sub_micrographs_again     #Name of your job
...
#SBATCH --output=job_results/testing_different_particle_sizes_and_random_sub_micrographs_again.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/testing_different_particle_sizes_and_random_sub_micrographs_again.e%j    #Path and name to the file for the STDERR
