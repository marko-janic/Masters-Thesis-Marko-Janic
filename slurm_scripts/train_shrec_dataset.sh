...
#SBATCH --job-name=different_particle     #Name of your job
...
#SBATCH --output=job_results/different_particle.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/different_particle.e%j    #Path and name to the file for the STDERR
