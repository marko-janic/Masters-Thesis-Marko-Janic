...
#SBATCH --job-name=shrec_dataset_training_grandmodel     #Name of your job
...
#SBATCH --output=job_results/shrec_dataset_training_grandmodel.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/shrec_dataset_training_grandmodel.e%j    #Path and name to the file for the STDERR
