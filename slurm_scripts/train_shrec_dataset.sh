...
#SBATCH --job-name=potential_best_model_fbp_20dB    #Name of your job
...
#SBATCH --output=job_results/potential_best_model_fbp_20dB.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/potential_best_model_fbp_20dB.e%j    #Path and name to the file for the STDERR
