...
#SBATCH --job-name=base_model_-5dB    #Name of your job
...
#SBATCH --output=job_results/base_model_-5dB.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/base_model_-5dB.e%j    #Path and name to the file for the STDERR
