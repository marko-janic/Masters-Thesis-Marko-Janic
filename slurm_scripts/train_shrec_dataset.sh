...
#SBATCH --job-name=best_model_shrec_reconstruction_base_FINAL    #Name of your job
...
#SBATCH --output=job_results/best_model_shrec_reconstruction_base_FINAL.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/best_model_shrec_reconstruction_base_FINAL.e%j    #Path and name to the file for the STDERR
