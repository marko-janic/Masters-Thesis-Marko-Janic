...
#SBATCH --job-name=smaller_model     #Name of your job
...
#SBATCH --output=job_results/smaller_model.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/smaller_model.e%j    #Path and name to the file for the STDERR
