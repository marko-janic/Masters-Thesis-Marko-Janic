...
#SBATCH --job-name=model_with_dropout2d_layers_prob_0_2     #Name of your job
...
#SBATCH --partition=rt4090
#SBATCH --gres=gpu:1          #--gres=gpu:2 for two GPU, etc
#SBATCH --output=job_results/model_with_dropout2d_layers_prob_0_2.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/model_with_dropout2d_layers_prob_0_2.e%j    #Path and name to the file for the STDERR
