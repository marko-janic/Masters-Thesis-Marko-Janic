...
#SBATCH --job-name=model_size_4x    #Name of your job
...
#SBATCH --output=job_results/model_size_4x.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/model_size_4x.e%j    #Path and name to the file for the STDERR
