...
#SBATCH --job-name=model_size_base    #Name of your job
...
#SBATCH --output=job_results/model_size_base.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/model_size_base.e%j    #Path and name to the file for the STDERR
