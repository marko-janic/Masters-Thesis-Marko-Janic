...
#SBATCH --job-name=shrec_dataset_grandmodel_one_heatmap     #Name of your job
...
#SBATCH --output=job_results/shrec_dataset_grandmodel_one_heatmap.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/shrec_dataset_grandmodel_one_heatmap.e%j    #Path and name to the file for the STDERR
