...
#SBATCH --job-name=best_model_10dB_base    #Name of your job
...
#SBATCH --output=job_results/best_model_10dB_base.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/best_model_10dB_base.e%j    #Path and name to the file for the STDERR
