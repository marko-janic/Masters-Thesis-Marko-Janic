...
#SBATCH --job-name=testing_validation_loss     #Name of your job
...
#SBATCH --output=job_results/testing_validation_loss.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/testing_validation_loss.e%j    #Path and name to the file for the STDERR
