...
#SBATCH --job-name=slightly_larger_model_fixed_big_dataset_bug_adjusted_z_range_slightly_larger_variances     #Name of your job
...
#SBATCH --output=job_results/slightly_larger_model_fixed_big_dataset_bug_adjusted_z_range_slightly_larger_variances.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/slightly_larger_model_fixed_big_dataset_bug_adjusted_z_range_slightly_larger_variances.e%j    #Path and name to the file for the STDERR
