...
#SBATCH --job-name=fbp_20dB_3_training_volumes    #Name of your job
...
#SBATCH --output=job_results/fbp_20dB_3_training_volumes.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/fbp_20dB_3_training_volumes.e%j    #Path and name to the file for the STDERR
