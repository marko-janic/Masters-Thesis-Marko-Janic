...
#SBATCH --job-name=bigger_model     #Name of your job
...
#SBATCH --output=job_results/bigger_model.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/bigger_model.e%j    #Path and name to the file for the STDERR
