...
#SBATCH --job-name=slightly_larger_model_dropout_0.1_adjusted_reshape_I_guess     #Name of your job
...
#SBATCH --output=job_results/slightly_larger_model_dropout_0.1_adjusted_reshape_I_guess.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/slightly_larger_model_dropout_0.1_adjusted_reshape_I_guess.e%j    #Path and name to the file for the STDERR
