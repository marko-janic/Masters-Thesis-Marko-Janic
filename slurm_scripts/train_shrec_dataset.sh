...
#SBATCH --job-name=training_with_shrecs_reconstruction_volume_bigger_model    #Name of your job
...
#SBATCH --output=job_results/training_with_shrecs_reconstruction_volume_bigger_model.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/training_with_shrecs_reconstruction_volume_bigger_model.e%j    #Path and name to the file for the STDERR
