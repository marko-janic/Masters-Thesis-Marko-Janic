...
#SBATCH --job-name=shrec_multiple_volumes_particle_1U6G     #Name of your job
...
#SBATCH --output=job_results/shrec_multiple_volumes_particle_1U6G.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/shrec_multiple_volumes_particle_1U6G.e%j    #Path and name to the file for the STDERR
