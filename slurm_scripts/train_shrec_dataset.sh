...
#SBATCH --job-name=noisy_fbp_5dB     #Name of your job
...
#SBATCH --output=job_results/noisy_fbp_5dB.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/noisy_fbp_5dB.e%j    #Path and name to the file for the STDERR
