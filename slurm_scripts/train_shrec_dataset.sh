...
#SBATCH --job-name=slightly_larger_model     #Name of your job
...
#SBATCH --output=job_results/slightly_larger_model.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/slightly_larger_model.e%j    #Path and name to the file for the STDERR
