...
#SBATCH --job-name=default     #Name of your job
...
#SBATCH --output=job_results/default.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/default.e%j    #Path and name to the file for the STDERR
