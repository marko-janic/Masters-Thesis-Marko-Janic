...
#SBATCH --job-name=base_model_shrec_reconstruction    #Name of your job
...
#SBATCH --output=job_results/base_model_shrec_reconstruction.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/base_model_shrec_reconstruction.e%j    #Path and name to the file for the STDERR
