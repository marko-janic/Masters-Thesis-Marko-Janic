...
#SBATCH --job-name=multiple_shrec_volumes_model_64_32_16     #Name of your job
...
#SBATCH --output=job_results/multiple_shrec_volumes_model_64_32_16.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/multiple_shrec_volumes_model_64_32_16.e%j    #Path and name to the file for the STDERR
