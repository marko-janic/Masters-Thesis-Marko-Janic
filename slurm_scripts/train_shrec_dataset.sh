...
#SBATCH --job-name=potential_best_model_fbp_10dB    #Name of your job
...
#SBATCH --output=job_results/potential_best_model_fbp_10dB.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/potential_best_model_fbp_10dB.e%j    #Path and name to the file for the STDERR
