...
#SBATCH --job-name=much_smaller_model_no_finetuning     #Name of your job
...
#SBATCH --output=job_results/much_smaller_model_no_finetuning.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/much_smaller_model_no_finetuning.e%j    #Path and name to the file for the STDERR
