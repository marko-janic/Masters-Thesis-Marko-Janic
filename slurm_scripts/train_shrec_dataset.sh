...
#SBATCH --job-name=huge_vit_10dB    #Name of your job
...
#SBATCH --output=job_results/huge_vit_10dB.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/huge_vit_10dB.e%j    #Path and name to the file for the STDERR
