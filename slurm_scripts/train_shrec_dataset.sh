...
#SBATCH --error=job_results/random_sub_micrographs_vit_not_in_eval_shuffle_true_in_dataloader_ADJUSTED_LOSS_LOGGING.e%j    #Path and name to the file for the STDERR
