...
#SBATCH --job-name=finetune_last_2_vit_blocks     #Name of your job
...
#SBATCH --output=job_results/finetune_last_2_vit_blocks.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/finetune_last_2_vit_blocks.e%j    #Path and name to the file for the STDERR
