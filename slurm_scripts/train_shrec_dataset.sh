...
#SBATCH --job-name=slightly_larger_model_dropout_0.1_adjusted_reshape_fixed_big_dataset_bug_smaller_particle_depth     #Name of your job
...
#SBATCH --output=job_results/slightly_larger_model_dropout_0.1_adjusted_reshape_fixed_big_dataset_bug_smaller_particle_depth.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/slightly_larger_model_dropout_0.1_adjusted_reshape_fixed_big_dataset_bug_smaller_particle_depth.e%j    #Path and name to the file for the STDERR
