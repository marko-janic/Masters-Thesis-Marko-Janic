...
#SBATCH --job-name=best_model_shrec_reconstruction_basex2    #Name of your job
...
#SBATCH --output=job_results/best_model_shrec_reconstruction_basex2.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/best_model_shrec_reconstruction_basex2.e%j    #Path and name to the file for the STDERR
