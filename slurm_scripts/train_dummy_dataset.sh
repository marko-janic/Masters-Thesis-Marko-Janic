...
#SBATCH --job-name=train_dummy_dataset_vit_pose_model     #Name of your job
...
#SBATCH --output=job_results/train_dummy_dataset_vit_pose_model.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/train_dummy_dataset_vit_pose_model.e%j    #Path and name to the file for the STDERR
