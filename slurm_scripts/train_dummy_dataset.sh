...
#SBATCH --output=job_results/train_dummy_dataset_smaller_epochs.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/train_dummy_dataset_smaller_epochs.e%j    #Path and name to the file for the STDERR
