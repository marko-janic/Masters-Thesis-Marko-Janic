...
#SBATCH --job-name=finetuning_ablation_study    #Name of your job
...
#SBATCH --output=job_results/finetuning_ablation_study.o%j   #Path and name to the file for the STDOUT
#SBATCH --error=job_results/finetuning_ablation_study.e%j    #Path and name to the file for the STDERR
...
#python main.py --config run_configs/ablation_studies/finetuning_vit/finetune_1_layers.json
#python main.py --config run_configs/ablation_studies/finetuning_vit/finetune_2_layers.json
